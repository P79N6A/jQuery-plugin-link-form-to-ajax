...
*       详细文档参见：http://add.corp.qihoo.net:8360/pages/viewpage.action?pageId=12877965
*
...
(function(){
    ...
    function submit2ajax(elEvent){
        ...
        var tagName = this.tagName, isForm = tagName=='FORM';

        //点击FORM时不触发Ajax提交
        if(isForm && elEvent.type=='click'){
            return;
        }
